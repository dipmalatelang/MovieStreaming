...
public class SharedPrefs {
    ...
    private static final String SHARED_PREFS_NAME = SharedPrefs.class.getSimpleName();
...
//        }
    ...
    public boolean getLastActivePlayed(String key, boolean defaultValue) {
        if (sharedPrefMap.containsKey(key)) {
            return (boolean) sharedPrefMap.get(key);
        }
    ...
    public void setLastActivePlayed(String key, boolean value) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(key, value);
        editor.apply();
        sharedPrefMap.put(key, value);
    ...
    public long getlastPositionVideo(String key, long defaultValue) {
        if (sharedPrefMap.containsKey(key)) {
            return (long) sharedPrefMap.get(key);
        }
    ...
    public void setlastPositionVideo(String key, long value) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putLong(key, value);
        editor.apply();
        sharedPrefMap.put(key, value);
