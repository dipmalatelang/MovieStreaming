...
public class CatSingleVideoAdapter extends RecyclerView.Adapter<CatSingleVideoAdapter.MyViewHolder> {
    Context mcontext ;
    List<AllDataPojo> mlist ;
    MovieItemClickListener movieItemClickListener;

    public CatSingleVideoAdapter(Context mcontext, List<AllDataPojo> mlist, MovieItemClickListener movieItemClickListener) {
