...
public class Userpojo {
    ...
    public Userpojo(String string) {
    }

    public Userpojo(String id, String name2, String email2, String password2, String phone2, String profileUri2, String createdAt2, String updatedAt2, String suscriptionDate2, UserPayment userPayments, String userType2, String expdate2) {
        this.id = id;
        this.name = name2;
        this.email = email2;
    ...
    public void setExpdate(String expdate2) {
        this.expdate = expdate2;
    }

    public String toString() {
        return "Userpojo{id='" + this.id + '\'' + ", name='" + this.name + '\'' + ", email='" + this.email + '\'' + ", phone='" + this.phone + '\'' + ", profileUri='" + this.profileUri + '\'' + ", createdAt='" + this.createdAt + '\'' + ", updatedAt='" + this.updatedAt + '\'' + ", suscriptionDate='" + this.suscriptionDate + '\'' + ", userPayments=" + this.payments + ", userType='" + this.userType + '\'' + ", expdate='" + this.expdate + '\'' + '}';
    }
}
